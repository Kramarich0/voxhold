...
function SidebarProvider({
  ...
  const setOpen = useCallback(
    async (value: boolean | ((value: boolean) => boolean)) => {
      ...
      await setClientCookie(SIDEBAR_COOKIE_NAME, openState, SIDEBAR_COOKIE_MAX_AGE);
    },
    [open, setOpenProp],
  );
...
function SidebarMenuButton({
  ...
  ComponentProps<"button"> & {
    ...
    tooltip?:
      | string
      | (Omit<ComponentProps<typeof AppTooltip>, "children"> & { children?: ReactNode });
  ...
  const tooltipProps =
    typeof tooltip === "string"
      ? { content: tooltip }
      : { content: tooltip.children ?? tooltip.content, ...tooltip };
